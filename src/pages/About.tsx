...
function About() {
    return (
        <Container className="mt-4">
            <div>
                <h3>Tools using</h3>
                <p>react-bootstrap && react-router-dom && @mantine/core && css && typescript-react </p>
            </div>
            <div>
            ...
            <div>
                ...
                <p>Name: Ahmed Mansour</p>
                <p>Email: ahmedmansour1239@gmail.com</p>
                <p>Phone Number: 01551973444</p>
            </div>
        </Container>
    )
}
